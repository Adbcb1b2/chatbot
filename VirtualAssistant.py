...
class VirtualAssistant:
    def __init__(self):
        ...
        self.responses = {
            ...
            "open": ["We are open from 9 AM to 6 PM, Monday to Friday.", "Our hours are 9 AM to 6 PM, Monday through Friday.", "We operate from 9 AM to 6 PM on weekdays."],
            "how are you": ["I'm just a program, but thanks for asking!", "Doing well, how about you?", "I'm here to assist you!"],
            "you okay": ["I'm just a program, but thanks for asking!", "Doing well, how about you?", "I'm here to assist you!"],
            "your name": ["I am a virtual assistant.", "You can call me Assistant.", "I'm your friendly AI assistant."],
            ...
            "returns": ["You can return any item within 30 days of purchase.", "Our return policy allows returns within 30 days. Would you like the steps?", "Returns are accepted within 30 days — do you need help with one?"],
            "order": ["You can check your order status on our website.", "To check your order status, please visit our order tracking page.", "Order status can be found in your account on our site."],
    ...
    def get_response(self, user_input):
        ...
        for key in self.responses:
            # Check if the key is a substring of the user input
            # This allows for partial matching, e.g., "can you tell me your name?" will match "your name"
